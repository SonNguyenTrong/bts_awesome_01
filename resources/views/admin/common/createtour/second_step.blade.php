                ...
                <div class="box-body">
                    <div class="form-row">
                        <div class="form-group col-xs-6">
                            ...
                            <button class="btn btn-success" @click="clearAllDayService()">{{ trans('message.clearall') }}</button>
                        </div>
                        <div class="clearfix">
                            &nbsp;
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-xs-12" v-bind:class="{ 'has-error': dayErrors && dayErrors.start_date }">
                            ...
                            <input type="date" class="form-control pull-right" v-model="days.start_date">
                    ...
                    <div class="form-row">
                        <div class="form-group col-xs-12" v-bind:class="{ 'has-error': dayErrors && dayErrors.end_date }">
                            ...
                            <input type="date" class="form-control pull-right" v-model="days.end_date">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12" v-bind:class="{ 'has-error': dayErrors && dayErrors.city }">
                            ...
                            <select id="inputState" name="author" v-model="days.city" class="form-control">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12" v-bind:class="{ 'has-error': dayErrors && dayErrors.service }">
                            <label for="exampleInputEmail1">{{ trans('message.service') }}</label>
                            <br>
                            <select class="selectpicker " multiple data-live-search="true" v-model="days.service">
                                <option>Mustard</option>
                                <option>Ketchup</option>
                                <option>Relish</option>
                            </select>
                            <span  v-if="dayErrors && dayErrors.service" class="help-block">@{{ dayErrors.service[0] }}</span>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12" v-bind:class="{ 'has-error': dayErrors && dayErrors.images }">
                            ...
                            <br>
                            <input type="file" v-on:change="pushDayImage" multiple>
                        </div>
                                        ...
                                        <div class="thumbnail customCard">
                                            ...
                                            <div class="caption card-footer text-center">
                                                <ul class="list-inline">
                                                    <li>@{{ day.city }}    -</li>
                                                    <li>Services :</li>
                                                    <li v-for="(serv, mark) in day.service">@{{ serv }}</li>
                                                </ul>
                                            </div>
                                            <div class="w-1/6 pr-2 xHolder">
                                                <i class="fa fa-times text-2xl" aria-hidden="true" @click="removeService(index)"></i>       
                                            </div>
                                        </div>
                                    </div>
                                </div>
